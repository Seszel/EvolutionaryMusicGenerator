...
public class ExperimentPopsizeGeneration {
    ...
    private static final List<Integer> NUMBER_OF_GENERATIONS = List.of(50, 75, 100, 200, 300, 500, 750, 1000);
...
//                    System.out.println("\nPopsize: " + popsize + ", Generation: " + generation);
                    runAlgorithm(new ImmutablePair<>(popsize, generation));
                }
            }

    }

    public static void runAlgorithm(Pair<Integer, Integer> parameters) {
