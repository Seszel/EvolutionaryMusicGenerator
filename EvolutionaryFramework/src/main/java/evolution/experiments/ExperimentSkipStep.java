...
public class ExperimentSkipStep {
    ...
    private static final List<Pair<String, Double>> MUTATION_TYPE = List.of(
            ...
            new ImmutablePair<>("BAR_ORDER", 3.0),
            new ImmutablePair<>("ADD_ZERO", 1.0),
            new ImmutablePair<>("ADD_REST", 1.0),
            new ImmutablePair<>("SWAP_NOTES", 3.0),
            new ImmutablePair<>("SWAP_DURATION", 3.0),
            new ImmutablePair<>("TRANSPOSE_NOTES", 6.0),
            new ImmutablePair<>("MUSICAL_CONTEXT", 0.0)
    );
    ...
    private static final List<String> CRITERIA = List.of("STEP_MOTION", "SKIP_MOTION");
